...
xsd_path = File.expand_path('../tmp/junos-system-15.1.xsd', __FILE__)
rule_path = File.expand_path('../tmp/rule.rb', __FILE__)
parser_path = File.expand_path('../lib/junoser/parser.rb', __FILE__)
